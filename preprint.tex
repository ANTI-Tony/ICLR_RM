...
Qwen2.5-7B-Instruct issue-only predictor, which sees only the issue text and file
...
(ii) An LLM-with-patch judge (Qwen2.5-7B-Instruct) that observes issue text, gold patch, and modified files. This serves as the \textbf{primary} consequence label in our experiments because it can see the realized fix.
