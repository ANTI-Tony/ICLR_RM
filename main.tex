...
under two preconditions the paper makes explicit --- heterogeneous
error costs and hard tasks that resist premium compute --- and the
out-of-domain probe confirms that where the preconditions fail, the
effects vanish as predicted. Beyond one-shot routing, a fully
