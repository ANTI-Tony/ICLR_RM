...
measures, however, makes a prompt-specific artifact unlikely. This
motivates the following question: how should a deployer wrap a
reasoning model so that it allocates compute effectively by
consequence?
