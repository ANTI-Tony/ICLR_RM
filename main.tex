...
$99.3\%$ of its sampled generations at its 8192-token cap. Claude Sonnet 4.5 with
...
($\rho = 0.002$). Qwen3-VL-8B-Thinking pins $99.3\%$ of its sampled generations at its
...
budget. On the same task set, $99.3\%$ of its sampled generations
reach the \texttt{max\_new\_tokens}$=8192$ cap ($99.7\%$ at a
$4096$ cap). With essentially every generation saturated, there is
