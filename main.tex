...
Yet under the cost-weighted objective, the median class-$2$ task
carries twice the cost-weighted marginal value of the median
class-$1$ task ($1.0$ vs $0.5$ under the $\{0,1,2\}$ mapping), and
class-$0$ tasks carry none.  Claude thus shows a weak emergent tendency
...
$93.9\%$ with $95\%$ interval $[86\%, 103\%]$
(Appendix~\ref{app:bootstrap}), so the two-decimal figure should be
...
\vspace{2pt}\par{\footnotesize $^{*}$The Random column in this table is a single fixed draw; the $1{,}000$-draw mean used in Table~\ref{tab:main} is $231.2$.}
\end{table}
