...
strategies would be dominated by class-$1$ weights. A second domain
that is naturally class-$2$-rich (e.g., database operations and
schema migrations) is the appropriate next step, as discussed in
